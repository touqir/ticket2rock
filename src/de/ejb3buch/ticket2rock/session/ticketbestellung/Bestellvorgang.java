...
public interface Bestellvorgang {
	...
	/**
	 * bucht eine Anzahl von Tickets zu einer Konzertveranstaltung. Falls das
	 * Konzert schon ausgebucht ist bzw. die Tickets nicht mehr verfügbar sind
	 * wird eine Exception geworfen.
	 * 
	 * @param konzert
	 *            das Konzert, für das Tickets gebucht werden
	 * @param ticketAnzahl
	 *            Anzahl der zu buchenden Tickets
	 */
	 ...
	 * 
	 * @param email
	 *            Email Adresse des Kunden, von dem die Tickets reserviert
	 *            werden.
	 */
