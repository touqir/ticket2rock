...
INSERT INTO INTERPRET (ID, TYP, NAME) VALUES (28, 'M', 'Craig Fairbaugh');
INSERT INTO INTERPRET (ID, TYP, NAME) VALUES (29, 'M', 'Shane Gallagher');
INSERT INTO INTERPRET (ID, TYP, NAME) VALUES (30, 'B', '+44');
...
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (1, 'Olympiastadion', 'München', 10000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (2, 'AOL Arena', 'Hamburg', 12000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (3, 'Volksfestgelände', 'Dresden', 9000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (4, 'Live Music Hall', 'Köln', 4000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (5, 'Elsehalle', 'München', 3500);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (6, 'Hugenottenhalle', 'Neu-Isenburg', 5000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (7, 'Longhorn', 'Stuttgart', 2000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (8, 'Postbahnhof', 'Berlin', 2500);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (9, 'Docks', 'Hamburg', 3500);

INSERT INTO TOURNEE (ID, NAME, INTERPRET_ID) VALUES (1, 'Stadium Arcadium Tour', 5);


INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (1, NULL, '2007-06-29', 1, 1, 12000, 65613, 'Berlin');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (2, NULL, '2007-07-01', 2, 1, 0, 65613, 'Berlin');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (3, NULL, '2007-07-04', 3, 1, 9000, 65613, 'Berlin');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (4, 30, '2007-01-20', 4, NULL, 4000, 127528, 'München');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (5, 30, '2007-01-23', 5, NULL, 3500, 127528, 'München');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (6, 30, '2007-01-27', 6, NULL, 5000, 127528, 'München');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (7, 30, '2007-01-28', 7, NULL, 2000, 127528, 'München');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (8, 30, '2007-01-30', 8, NULL, 2500, 127528, 'München');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (9, 30, '2007-01-31', 9, NULL, 3500, 127528, 'München');
