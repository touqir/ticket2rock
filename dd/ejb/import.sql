...
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (1, 'Colorline Arena', 'Hamburg', 12000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (2, 'Festhalle', 'Frankfurt/ Main', 10000);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET) VALUES (3, 'Schleyer Halle', 'Stuttgart', 9000);

INSERT INTO TOURNEE (ID, NAME, INTERPRET_ID) VALUES (1, 'Stadium Arcadium Tour', 5);

INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, TICKETKONTINGENT) VALUES (1, NULL, '2006-11-24', 1, 1, 12000);
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, TICKETKONTINGENT) VALUES (2, NULL, '2006-11-26', 2, 1, 0);
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, TICKETKONTINGENT) VALUES (3, NULL, '2006-11-27', 3, 1, 9000);
