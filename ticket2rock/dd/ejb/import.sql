...
INSERT INTO INTERPRET (ID, TYP, NAME, GEBURTSNAME, GRUENDUNGSJAHR) VALUES (21, 'M', 'TrŽ Cool', 'Frank Edwin Wright III', NULL);
...
INSERT INTO VERANSTALTER (NAME, HR_NR, AMTSGERICHT) VALUES ('target Concerts GmbH', 127528, 'MŸnchen');

INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET, GEO_BREITE, GEO_LAENGE) VALUES (1, 'Olympiastadion', 'MŸnchen', 100000, 48.174729, 11.550729);
...
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET, GEO_BREITE, GEO_LAENGE) VALUES (3, 'VolksfestgelŠnde', 'Dresden', 9000, 51.067857, 13.706474);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET, GEO_BREITE, GEO_LAENGE) VALUES (4, 'Live Music Hall', 'Kšln', 4000, 50.948671, 6.910433);
INSERT INTO VERANSTALTUNGSORT (ID, NAME, ADRESSE, KAPAZITAET, GEO_BREITE, GEO_LAENGE) VALUES (5, 'Elserhalle', 'MŸnchen', 3500, 48.121757, 11.603923);
...
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (4, 30, '2007-01-20', 4, NULL, 4000, 40.00, 127528, 'MŸnchen');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (5, 30, '2007-01-23', 5, NULL, 3500, 45.00, 127528, 'MŸnchen');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (6, 30, '2007-01-27', 6, NULL, 5000, 55.50, 127528, 'MŸnchen');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (7, 30, '2007-01-28', 7, NULL, 2000, 30.00, 127528, 'MŸnchen');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (8, 30, '2007-01-30', 8, NULL, 2500, 32.50, 127528, 'MŸnchen');
INSERT INTO KONZERT (ID, INTERPRET_ID, DATUM, VERANSTALTUNGSORT_ID, TOURNEE_ID, KONTINGENT, TICKETPREIS, VERANSTALTER_HR_NR, VERANSTALTER_AMTSGERICHT) VALUES (9, 30, '2007-01-31', 9, NULL, 3500,65.50, 127528, 'MŸnchen');
