...
3. Eine erforderliche Queue im JBoss installieren.
...
Dafür kopieren Sie einfach die im Projektverzeichnis vorhandene Konfigurationsdatei ticket2rock-hornetq-jms.xml in das
deploy Verzeichnis der gewählten Serverkonfiguration (also z. Bsp.: $JBOSS_HOME/server/default/deploy).
